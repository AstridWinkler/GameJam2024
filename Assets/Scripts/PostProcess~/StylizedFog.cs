...
public sealed class StylizedFog : PostProcessEffectSettings
{
    ...
    // [Tooltip("Gradient for the fog color."), DisplayName("Gradient"), SerializeField]

    [Tooltip("Gradient for the fog color."), DisplayName("Gradient"), SerializeField]
    public GradientParameter gradient = new GradientParameter { value = new Gradient() };
    // public Gradient gradient = new Gradient();

    [Tooltip("Gradient for the fog color."), DisplayName("GradientTex")]
...
public class StylizedFogRenderer : PostProcessEffectRenderer<StylizedFog>
{
    ...
    public override void Render(PostProcessRenderContext context)
	{
       ...
       // var gradientTexture = settings.gradientTexture;
