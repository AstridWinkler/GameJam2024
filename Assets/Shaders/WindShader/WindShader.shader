...
Shader "MrKata/WindShader"
{

        Properties{
            _MainTex("Main Texture", 2D) = "white" {}
            _Tint("Tint", Color) = (1,1,1,1)
            _wind_speed("Speed", range(-10,10)) = 1
            _wind_amp("Amplitude", range(0,1)) = 1
               ...
               float _wind_amp;
                ...
                void vert(inout appdata_full i) {
                   ...
                   */
                   ...
                   i.vertex.x += (cos(_Time.z* _wind_speed + worldPos.y + worldPos.z*10)* sin(_Time.w * _wind_speed * 0.1f + worldPos.x + worldPos.z * 10) * _wind_amp);
                   i.vertex.y += (cos(_Time.w * _wind_speed + worldPos.y + worldPos.z * 10) * _wind_amp)*0.01f;
