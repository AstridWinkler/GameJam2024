...
namespace logiked.source.extentions
{
    ...
    /// <summary>
    /// Extentions pour les SerializedProperty
    /// </summary>
    public static class SerializedPropertyExtensions
    {
        /// <summary>
        /// Extraire la valeur de type T depuis cette propriété (object par exemple)
        /// </summary>
        /// <typeparam name="T">Le type de valeur a extraire</typeparam>
        /// <param name="property">La propiété</param>
        /// <returns>La valeur extraite</returns>
        ...
        /// <summary>
        /// Assigne la valeur de type T à cette propriété
        /// </summary>
        /// <typeparam name="T">Le type de valeur a assigner</typeparam>
        /// <param name="property">La propiété</param>
        /// <param name="value">La nouvelle valeur</param>
        /// <returns>True si la valeur à correctement été assignée</returns>
